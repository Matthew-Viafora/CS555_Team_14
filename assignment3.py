...
for family in list(families.values()):
    if individuals[family['HUSB']]['SEX']!="M":
        print("ERROR US21: Gender of "+individuals[family['HUSB']]['NAME']+' ('+family['HUSB']+') '+"needs to be male.")
    if individuals[family['WIFE']]['SEX']!="F":
        print("ERROR US21: Gender of "+individuals[family['WIFE']]['NAME']+' ('+family['WIFE']+') '+"needs to be female.")
...
print("List of people who were born in the last 30 days: "+str(people))
